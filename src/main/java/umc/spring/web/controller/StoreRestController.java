...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistStore @PathVariable(name = "storeId") Long storeId, @RequestParam(defaultValue = "1") Integer pageNum){
